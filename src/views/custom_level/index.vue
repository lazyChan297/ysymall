    ...
    <div class="customeLevel-wrapper" v-if="ready">
        ...
        <div class="article">
            <div>
                ...
                <div class="content">
                    <input type="tel" placeholder="请输入赠送数量" v-model="vipQuota" @blur="scrolltoTop">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="content">
                   <input type="tel" placeholder="请输入赠送数量" v-model="generalAgentQuota" @blur="scrolltoTop">
                </div>
            </div>
        ...
        <div class="article">
                <div>
                    ...
                    <div class="content">
                        <input type="tel" v-model="payableAmount" @blur="scrolltoTop">
                    </div>
                </div>
                <div>
                    <span class="label">实收金额</span>
                    <div class="content">
                        <input type="tel" v-model="paidAmount" @blur="scrolltoTop">
                    </div>
                </div>
                <div>
        ...
        <x-dialog v-model="isShowDialog">
            <div class="confirm-container">
                ...
                <div class="confirm-content">
                    ...
                    <div class="cell">
                        <input type="tel" placeholder="请输入验证码" v-model="captcha" @blur="scrolltoTop">
                    </div>
                </div>
